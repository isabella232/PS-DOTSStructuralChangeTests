...
public class WeaponEquipSystem_HandlerUsingCustomEntityManager : SystemBase
{
    ...
    protected override void OnUpdate()
    {
        ...
        {
            EntityManager.DoCustomCommand(command);
        }
    }
    ...
    public struct CommandReceiver
    {
        ...
        public CommandReceiver(WeaponEquipSystem_HandlerUsingCustomEntityManager parent)
        {
...
[UpdateBefore(typeof(WeaponEquipSystem_HandlerUsingCustomEntityManager))]
public class WeaponEquipSystemTest_HandlerUsingCustomEntityManager : SystemBase
{
    ...
    struct WeaponEquipJob : IJobChunk
    {
        ...
        public WeaponEquipSystem_HandlerUsingCustomEntityManager.CommandReceiver commandReceiver;
    ...
    protected override void OnUpdate()
    {
        var weaponEquipSystem = World.GetExistingSystem<WeaponEquipSystem_HandlerUsingCustomEntityManager>();
        if (weaponEquipSystem.IsInitialized())
        {
            ...
            var job = new WeaponEquipJob()
            {
                ...
                commandReceiver = new WeaponEquipSystem_HandlerUsingCustomEntityManager.CommandReceiver(weaponEquipSystem)
            };

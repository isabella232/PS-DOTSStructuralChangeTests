...
public class WeaponEquipSystem_HandlerUsingCustomEntityManagerV2 : SystemBase
{
    ...
    protected override void OnUpdate()
    {
        ...
        EntityManager.DoCustomCommands(commandQueue.ToArray(Allocator.Temp));
        commandQueue.Clear();
    }
    ...
    public struct CommandReceiver
    {
        ...
        public CommandReceiver(WeaponEquipSystem_HandlerUsingCustomEntityManagerV2 parent)
        {
...
[UpdateBefore(typeof(WeaponEquipSystem_HandlerUsingCustomEntityManagerV2))]
public class WeaponEquipSystemTest_HandlerUsingCustomEntityManagerV2 : SystemBase
{
    ...
    struct WeaponEquipJob : IJobChunk
    {
        ...
        public WeaponEquipSystem_HandlerUsingCustomEntityManagerV2.CommandReceiver commandReceiver;
    ...
    protected override void OnUpdate()
    {
        var weaponEquipSystem = World.GetExistingSystem<WeaponEquipSystem_HandlerUsingCustomEntityManagerV2>();
        if (weaponEquipSystem.IsInitialized())
        {
            ...
            var job = new WeaponEquipJob()
            {
                ...
                commandReceiver = new WeaponEquipSystem_HandlerUsingCustomEntityManagerV2.CommandReceiver(weaponEquipSystem)
            };
